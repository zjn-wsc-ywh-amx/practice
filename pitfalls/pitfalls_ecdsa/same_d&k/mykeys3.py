...
class SigningKey(object):
    ...
    def sign(
        ...
        a,K = self.sign_digest(h, k1,d,entropy, sigencode, k, allow_truncate)
        return a,K
    ...
    def sign_digest(
        ...
        r, s ,K  = self.sign_number(number,k1,d, entropy, k)
        return sigencode(r, s, self.privkey.order),(r,s,K)

    def sign_number(self, number,k1,d,entropy=None, k=None):
        """
        ...
        assert 1 <= _k < order
        sig,K  = self.privkey.sign(number,k1, _k,d)
        return sig.r, sig.s,K
