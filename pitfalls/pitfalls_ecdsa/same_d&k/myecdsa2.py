...
class Public_key(object):
    ...
    def verifies(self, hash, signature):
        ...
        if s < 1 or s > n - 1:
            return False
        c = numbertheory.inverse_mod(s, n)#c是s-1
        u1 = (hash * c) % n
        u2 = (r * c) % n
...
class Private_key(object):
    ...
    def sign(self, hash,k1 ,random_k,d):
        ...
        print("private_key = {}".format(self.secret_multiplier))
        #d = self.secret_multiplier
        if s == 0:
