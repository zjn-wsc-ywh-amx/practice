...
class SigningKey(object):
    ...
    def from_secret_exponent(cls, secexp, curve=NIST192p, hashfunc=sha1):
        ...
        self.privkey = myecdsa.Private_key(pubkey, secexp)
    ...
    def sign(
        ...
        a,K = self.sign_digest(h, entropy, sigencode, k, allow_truncate)
        return a,K
    ...
    def sign_digest(
        ...
        r, s ,K ,d = self.sign_number(number, entropy)
    ...
    def sign_number(self, number, entropy=None, k=None):
        ...
        assert 1 <= _k < order
        sig,K ,d  = self.privkey.sign(number, _k)
