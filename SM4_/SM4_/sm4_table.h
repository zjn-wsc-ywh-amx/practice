...
/*用T_table的方法来进行计算*/
#define SIZE 256
u32 t1_table[SIZE] = { 0x8ED55B5B, 0xD0924242, 0x4DEAA7A7, 0x06FDFBFB, 0xFCCF3333, 0x65E28787,
...
u32 t2_table[SIZE] = { 0x5B8ED55B, 0x42D09242, 0xA74DEAA7, 0xFB06FDFB, 0x33FCCF33, 0x8765E287,
...
u32 t3_table[SIZE] = { 0x5B5B8ED5, 0x4242D092, 0xA7A74DEA, 0xFBFB06FD, 0x3333FCCF, 0x878765E2,
...
u32 t4_table[SIZE] = { 0xD55B5B8E, 0x924242D0, 0xEAA7A74D, 0xFDFBFB06, 0xCF3333FC, 0xE2878765,
...
u32 T(u32 m);
u32 T1(u32 m);
void GetRK(u32 MK[], u32 RK[]); // 轮密钥获取算法

void encryptSM4(u32 X[4], u32 RK[32], u32 Y[4]); // 加密算法
void decryptSM4(u32 X[4], u32 RK[32], u32 Y[4]); // 解密算法
